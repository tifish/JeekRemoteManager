...
- Integrated AI agents: use Claude, Codex, Grok, GitHub Copilot, OpenCode, Pi, OMP, Cursor CLI, or Antigravity to operate the current SSH terminal; Copilot also supports its desktop app, and generated workspaces open in VS Code, Cursor, Zed, or Antigravity IDE
