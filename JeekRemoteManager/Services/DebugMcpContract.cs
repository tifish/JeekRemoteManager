...
public static class DebugMcpContract
{
    ...
    public static JsonArray BuildToolList() => new(
        ...
        Tool("terminal_tab_title_check",
            "Build and measure the real terminal-tab title controls, verifying that long names preserve the last six characters and expose the full name as a tooltip.",
            new()),
