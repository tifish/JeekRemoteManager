...
- 集成 AI Agent，支持使用 Claude/Codex/Grok/GitHub Copilot/OpenCode/Pi/OMP/Antigravity 操作当前 SSH 终端；Copilot 同时支持 Desktop，也可将生成的工作区在 VS Code、Cursor 或 Antigravity IDE 中打开
- SFTP 远程文件浏览器
